<h2>891. Sum of Subsequence Widths</h2><h3>Hard</h3><hr><div><p>The <strong>width</strong> of a sequence is the difference between the maximum and minimum elements in the sequence.</p>
